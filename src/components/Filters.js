        ...
        <div>
          {
            categories.map((c, idx) => {
              return <button key={idx} onClick={updateFilters} name="category" 
                type='button' className={`${category === c.toLowerCase()? "active": null}`} >{c}</button>
            })
          }
        </div>
      </div>
        ...
        <div className='colors'>
          {
            colors.map((c, idx) => {
              ...
              return <button key={idx} name="color" style={{background: c}} 
